...
# Create a logger
csv_logger = CSVLogger('../weights/transfer_vgg16.csv', append=False)

# Create a checkpoint object
model_checkpoint = ModelCheckpoint(
        '../weights/transfer_vgg16.h5',
        monitor='val_acc',
        save_best_only=True,
        period=1)

# Loads the pre-trained vgg16 model without the top layer as our base
base_model = VGG16(
        include_top=False,
        weights='imagenet',
